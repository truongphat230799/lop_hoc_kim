...
export const statCards: StatCard[] = [
  {
    ...
    value: "6 khối",
    note: "Đầy đủ phiếu ôn tập môn Toán, Tiếng Việt, Tiếng Anh và kỹ năng sống.",
  },
  {
    label: "Đề chấm điểm",
    value: "12",
    note: "Học sinh làm bài trực tuyến, hệ thống chấm điểm và xem đáp án ngay lập tức.",
  },
  {
    label: "Trò chơi cho bé",
    value: "3",
    note: "Các hoạt động tương tác giúp trẻ làm quen chữ cái, đếm số và ghép vần vui nhộn.",
  },
];
...
export const externalResources: ExternalResource[] = [
  {
    ...
    note: "Tuyển tập câu hỏi trắc nghiệm Toán lớp 1 giúp bé rèn luyện phản xạ và củng cố kiến thức cơ bản.",
  ...
  },
  {
    ...
    note: "Bộ đề ôn tập học kỳ môn Tiếng Việt với các câu hỏi đa dạng theo sát chương trình học.",
  ...
  },
  {
    ...
    subject: "math",
    format: "Bộ đề / đáp án",
    note: "Tài liệu Toán lớp 2 giúp bé luyện tập các phép tính cộng, trừ và giải toán có lời văn cơ bản.",
  ...
  },
  {
    ...
    subject: "vietnamese",
    format: "Đề thi / đáp án",
    note: "Đề thi và bài tập Tiếng Việt lớp 2 hỗ trợ bé củng cố kỹ năng đọc hiểu và từ vựng phong phú.",
  ...
  },
  {
    ...
    note: "Các dạng bài toán có lời văn lớp 3 từ cơ bản đến nâng cao để rèn luyện tư duy toán học.",
  ...
  },
  {
    ...
    subject: "english",
    format: "Đề thi / đáp án",
    note: "Tuyển tập đề thi và câu hỏi tiếng Anh lớp 3 giúp làm quen từ vựng, mẫu câu giao tiếp cơ bản.",
  ...
  },
  {
    ...
    note: "Chuyên đề phân số Toán lớp 4 giúp học sinh nắm vững lý thuyết và rèn luyện kỹ năng làm bài tập.",
  ...
  },
  {
    ...
    note: "Bộ câu hỏi đọc hiểu Tiếng Việt lớp 4 rèn luyện khả năng phân tích, cảm thụ văn học và mở rộng từ vựng.",
  ...
  },
  {
    ...
    subject: "math",
    format: "Chuyên đề / đáp án",
    note: "Tài liệu chuyên đề Toán lớp 5 hỗ trợ học tập tại nhà và chuẩn bị hành trang chuyển cấp.",
  ...
  },
  {
    ...
    note: "Tổng hợp bài tập luyện từ và câu Tiếng Việt lớp 5 giúp củng cố kiến thức ngữ pháp vững chắc.",
  ...
  },
  {
    ...
    note: "Tài liệu ngữ pháp và bài tập thực hành tiếng Anh lớp 5 giúp nâng cao toàn diện các kỹ năng.",
